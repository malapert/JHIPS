...
public class Projection {
    ...
    public enum ProjectionType {CAR, TAN};
    
    private static double[] unProjectTan(double[] centerCameraPixels, double[] cameraHori, double[] scale, double[] rotation, double azimuth, double elevation) {
    ...
    public static double[] unProject(double[] cameraPixel, double[] cameraHori, double[] scale, double[] rotation, double azimuth, double elevation, ProjectionType type) {
        double[] xy;
        switch(type) {
            case TAN:
